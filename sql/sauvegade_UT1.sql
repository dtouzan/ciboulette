--
-- Fichier généré par SQLiteStudio v3.4.4 sur lun. déc. 11 23:58:33 2023
--
...
CREATE TABLE IF NOT EXISTS Observation ( 
	SCIENCE_PROGRAM_ID   INTEGER NOT NULL    ,
	OBSERVATION_ID       INTEGER NOT NULL    ,
	TITLE                TEXT(1024)     ,
	COLLECTION           TEXT(1024)     ,
	PROPOSAL_PI          TEXT(1024)     ,
	PRIORITY             INTEGER     ,
	SATUS                INTEGER     ,
	SCHEDULING           TEXT(1024)  DEFAULT ('2023-01-01T00:00:00')   ,
	FITS_FILE            TEXT(1024)     ,
	NOTE_FILE            TEXT(1024)     ,
	CALIBRATION          INTEGER     ,
	CONSTRAINT unq_Observation_OBSERVATION_ID UNIQUE ( OBSERVATION_ID ),
	FOREIGN KEY ( SCIENCE_PROGRAM_ID ) REFERENCES ScienceProgram( SCIENCE_PROGRAM_ID )  
 );
...
CREATE TABLE IF NOT EXISTS ScienceProgram (SCIENCE_PROGRAM_ID INTEGER UNIQUE NOT NULL, TITLE TEXT (1024), STATUS INTEGER DEFAULT (1), CONTACT TEXT (1024) DEFAULT "dtouzan@gmail.com", OBSERVING_TIME REAL, TYPE TEXT (1024) DEFAULT science, DATASET TEXT (1024) DEFAULT dataset);
INSERT INTO ScienceProgram (SCIENCE_PROGRAM_ID, TITLE, STATUS, CONTACT, OBSERVING_TIME, TYPE, DATASET) VALUES (1000, 'UT1 science program 2016-2023', 0, 'dtouzan@gmail.com', '', 'science', 'dataset/archives');
